...
<#-- @ftlvariable name="item" type="org.onehippo.forge.security.support.springsecurity.demo.beans.Blogpost" -->
<#-- @ftlvariable name="author" type="org.onehippo.forge.security.support.springsecurity.demo.beans.Author" -->
